...
INSERT INTO noticia(id,titulo,subtitulo,conteudo,data,categoria,statusNoticia) VALUES(200,'Carro explode com drogras','Trafico','Nessa noite de sábado','25/10/2024','MUSICA','APROVADO');
INSERT INTO noticia(id,titulo,subtitulo,conteudo,data,categoria,statusNoticia) VALUES(201,'Traficante fica milhorario','Dinheiro do trafico','Da noite pro dia homem ficou milhonario','22/05/2022','SAUDE','APROVADO');
INSERT INTO noticia(id,titulo,subtitulo,conteudo,data,categoria,statusNoticia) VALUES(202,'Casa noturna cheia das do job','mulheres ganham mais que prefeito','Mulheres da noite são as mais ricas da atualidade','15/03/2015','ESPORTE','PENDENTE');
INSERT INTO noticia(id,titulo,subtitulo,conteudo,data,categoria,statusNoticia) VALUES(203,'Bingo rende mais dinheiro que o show das primas','Bingo em alta em toda a cidade','Casas de bingo online ganham a cena','11/11/2024','ALIMENTACAO','NEGADO');
